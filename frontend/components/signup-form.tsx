...
import { Eye, EyeOff, Mail, Lock, User, Phone, Calendar, Check, X } from "lucide-react"
  ...
  return (
    <div className="w-full max-w-sm mx-auto mt-6">
      <div className="text-center mb-6">
        <h1 className="text-3xl font-bold text-white mb-1 text-left">Your Dream Body Is Just A Sign Up Away.</h1>
      </div>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <Label htmlFor="confirmPassword" className="text-gray-300 block mb-2">Confirm Password *</Label>
            <div className="relative">
              <Lock className="absolute left-3 top-4 h-4 w-4 text-gray-500" />
              <Input
                id="confirmPassword"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <Label htmlFor="contactNo" className="text-gray-300 block mb-2">Contact No *</Label>
            <div className="relative">
          ...
          <div>
            <Label htmlFor="dob" className="text-gray-300 block mb-2">Date of Birth</Label>
            <div className="relative">
        ...
        <Button
          type="submit"
          className="w-full px-8 py-3 bg-white hover:bg-gray-100 text-black border border-gray-300 disabled:opacity-50 disabled:cursor-not-allowed"
          disabled={isLoading}
        >
