...
export default function MemberReportsPage() {
  ...
  const handleGenerateReport = async () => {
    try {
      ...
      const fileName = `my-fitness-report-${reportType}-${new Date().toISOString().split('T')[0]}.${reportFormat === 'pdf' ? 'pdf' : 'xlsx'}`
      a.download = fileName
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Generate detailed reports of your fitness progress
          </p>
        </div>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Configure your personal report settings
            </CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Your personal fitness report will include
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-medium">Your Workouts</p>
                  <p className="text-sm text-muted-foreground">
                    All your exercise logs, sets, reps, and weights
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-medium">Your Nutrition</p>
                  <p className="text-sm text-muted-foreground">
                    Meal logs, calories, and macronutrient breakdown
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Your totals, averages, and progress trends
                  </p>
                </div>
              </div>
            </div>
        ...
        <Card className="hover:shadow-md transition-shadow cursor-pointer" onClick={() => { setReportType('daily'); setReportFormat('pdf'); }}>
          <CardContent className="p-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm font-medium">Today's PDF</span>
            </div>
          </CardContent>
        </Card>
        ...
        <CardContent className="p-4">
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Your reports contain only your personal fitness data. No other member's information is included.
              </p>
            </div>
          </div>
        </CardContent>
