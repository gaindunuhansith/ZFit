...
import recurringPayRoutes from "./routes/recurringPay.routes.js";  // Added recurring payment routes
...
app.use('/api/v1/recurring-payments', recurringPayRoutes);  // Added recurring payment routes
