...
import reportPaymentRoutes from "./routes/reportPayment.routes.js";  // Added report payment routes
...
app.use('/api/v1/reports', reportPaymentRoutes);  // Added report payment routes
